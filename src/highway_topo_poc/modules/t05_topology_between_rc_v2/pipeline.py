...
DEFAULT_PARAMS: dict[str, Any] = {
    ...
    "ROAD_SMALL_GAP_RELAXED_DRIVEZONE_RATIO": 0.65,
    ...
    "ARC_STITCH_TERMINAL_ANCHOR_MAX_SEQ_GAP": 16,
    "ARC_SUPPORT_MIN_DRIVABLE_RATIO": 0.70,
    "ARC_SUPPORT_MIN_DRIVEZONE_RATIO": 0.85,
    "ARC_SUPPORT_MAX_DIVSTRIP_RATIO": 0.05,
    "ARC_SUPPORT_NEAR_FULL_XSEC_MIN_COVERAGE_RATIO": 0.72,
    "ARC_SUPPORT_NEAR_FULL_XSEC_MAX_SPAN_COUNT": 2,
    "ARC_SUPPORT_FULL_XSEC_SIDE_CLUSTER_RESOLUTION": 0.2,
    "ARC_SUPPORT_ANCHOR_CLUSTER_RESOLUTION_M": 10.0,
    "ARC_SUPPORT_CLUSTER_CORRIDOR_MID_RESOLUTION_M": 8.0,
    "ARC_SUPPORT_CLUSTER_CORRIDOR_ANCHOR_RESOLUTION_M": 12.0,
    "ARC_TRUSTED_FULL_XSEC_SINGLE_CLUSTER_MIN_COUNT": 2,
    "ARC_SUPPORT_COMPETING_ARC_MIN_MARGIN_M": 1.5,
    "ARC_TRUSTED_SINGLE_STITCHED_SIDE_TOL": 0.15,
    "ARC_TRUSTED_SINGLE_STITCHED_ANCHOR_TOL_M": 8.0,
    "STEP3_SAME_PAIR_SUPPORT_DECONFLICT_TOPK": 6,
    "STEP5_SLOT_ANCHOR_TOL_M": 0.75,
    "GLOBAL_FIT_ENABLE": 1,
    "GLOBAL_FIT_STATION_STEP_M": 6.0,
    "GLOBAL_FIT_MIN_STATION_COUNT": 9,
    "GLOBAL_FIT_MAX_STATION_COUNT": 55,
    "GLOBAL_FIT_TRAJ_SAMPLE_SEARCH_M": 14.0,
    "GLOBAL_FIT_GUIDE_BUFFER_M": 18.0,
    "GLOBAL_FIT_MIN_TRAJ_OVERLAP_RATIO": 0.28,
    "GLOBAL_FIT_MIN_SPINE_QUALITY": 0.35,
    "GLOBAL_FIT_TRAJECTORY_WEIGHT": 2.6,
    "GLOBAL_FIT_GUIDE_WEIGHT": 0.32,
    "GLOBAL_FIT_SMOOTHNESS_WEIGHT": 1.8,
    "GLOBAL_FIT_SMOOTHING_ITERATIONS": 18,
    "GLOBAL_FIT_LANE_BOUNDARY_SEARCH_M": 12.0,
    "GLOBAL_FIT_LANE_BOUNDARY_PAIR_MIN_SEP_M": 1.5,
    "GLOBAL_FIT_LANE_BOUNDARY_PAIR_MAX_SEP_M": 18.0,
    "GLOBAL_FIT_LANE_BOUNDARY_TARGET_WIDTH_M": 6.0,
    "GLOBAL_FIT_LANE_HINT_MIN_QUALITY": 0.45,
    "GLOBAL_FIT_LANE_HINT_HIGH_QUALITY": 0.70,
    "GLOBAL_FIT_LANE_HINT_MAX_WEIGHT": 0.35,
    "GLOBAL_FIT_CENTER_CORRECTION_BASE_BLEND": 0.48,
    "GLOBAL_FIT_CENTER_CORRECTION_MAX_BLEND": 0.68,
    "GLOBAL_FIT_CENTER_CORRECTION_WEAK_SCALE": 0.55,
    "GLOBAL_FIT_CENTER_CORRECTION_MAX_SHIFT_M": 2.6,
    "GLOBAL_FIT_CORRECTED_SPINE_WEIGHT": 3.2,
    "GLOBAL_FIT_CENTERLINE_PENALTY_WEIGHT": 2.0,
    "GLOBAL_FIT_LOCAL_CENTER_COMPENSATION_MAX_USAGE_RATIO": 0.35,
    "GLOBAL_FIT_LOCAL_CENTER_COMPENSATION_MIN_HINT_COUNT": 3,
    "GLOBAL_FIT_LOCAL_CENTER_COMPENSATION_MIN_HIGH_QUALITY_COUNT": 2,
    "GLOBAL_FIT_LOCAL_CENTER_COMPENSATION_WINDOW_M": 24.0,
    "GLOBAL_FIT_LOCAL_CENTER_COMPENSATION_MISSING_BLEND": 0.72,
    "GLOBAL_FIT_LOCAL_CENTER_COMPENSATION_WEAK_BLEND": 0.42,
    "GLOBAL_FIT_LOCAL_CENTER_COMPENSATION_MAX_SHIFT_M": 2.8,
    "GLOBAL_FIT_LOCAL_CENTER_COMPENSATION_ITERATIONS": 12,
    "GLOBAL_FIT_ENDPOINT_TANGENT_ENABLE": 1,
    "GLOBAL_FIT_ENDPOINT_TANGENT_WINDOW_M": 18.0,
    "GLOBAL_FIT_ENDPOINT_TANGENT_SAMPLE_M": 10.0,
    "GLOBAL_FIT_ENDPOINT_TANGENT_WEIGHT": 2.8,
    "GLOBAL_FIT_ENDPOINT_NEIGHBORHOOD_WEIGHT": 2.1,
    "GLOBAL_FIT_ENDPOINT_REFIT_THRESHOLD_DEG": 20.0,
    "GLOBAL_FIT_ENDPOINT_REFIT_WINDOW_M": 24.0,
    "GLOBAL_FIT_ENDPOINT_REFIT_STRENGTH": 0.78,
    "GLOBAL_FIT_ENDPOINT_REFIT_ITERATIONS": 4,
    "GLOBAL_FIT_LANE_GATE_MIN_QUALITY": 0.52,
    "GLOBAL_FIT_LANE_GATE_MAX_OFFSET_M": 3.5,
    "GEOMETRY_REFINE_ENABLE": 1,
    "GEOMETRY_REFINE_CORE_TRIM_FRAC": 0.15,
    "GEOMETRY_REFINE_MAX_DRIVEZONE_DROP": 0.03,
    "GEOMETRY_REFINE_LANE_BOUNDARY_SEARCH_M": 12.0,
    "GEOMETRY_REFINE_LANE_BOUNDARY_PAIR_MIN_SEP_M": 1.5,
    "GEOMETRY_REFINE_LANE_BOUNDARY_PAIR_MAX_SEP_M": 18.0,
    "GEOMETRY_REFINE_LANE_BOUNDARY_TARGET_WIDTH_M": 6.0,
    "GEOMETRY_REFINE_LANE_BOUNDARY_MIN_QUALITY_SCORE": 0.45,
    "GEOMETRY_REFINE_LANE_BOUNDARY_BLEND_MAX_WEIGHT": 0.32,
    "GEOMETRY_REFINE_SMOOTH_SAMPLE_STEP_M": 8.0,
    "GEOMETRY_REFINE_ENTRY_EXIT_CTRL_FRAC": 0.35,
    "GEOMETRY_REFINE_ENTRY_EXIT_CTRL_MIN_M": 2.5,
    "GEOMETRY_REFINE_ENTRY_EXIT_CTRL_MAX_M": 14.0,
    "GEOMETRY_REFINE_HARD_MIN_DRIVEZONE_RATIO": 0.93,
    "GEOMETRY_REFINE_ENDPOINT_FIT_SCORE_SCALE_M": 3.0,
    "GEOMETRY_REFINE_GEOMETRY_SCORE_SCALE_M": 6.0,
    "GEOMETRY_REFINE_CENTERING_SCORE_SCALE_M": 4.0,
    "GEOMETRY_REFINE_SMOOTHNESS_CAP_DEG": 55.0,
    "GEOMETRY_REFINE_MIN_SCORE_GAIN": 0.03,
    "GEOMETRY_REFINE_LANE_BOUNDARY_BUFFER_M": 9.0,
    "GEOMETRY_REFINE_ORIGINAL_WEAK_BUFFER_M": 5.0,
    "GEOMETRY_REFINE_ANCHOR_MAX_SNAP_DIST_M": 3.0,
    "STEP3_TOPOLOGY_GAP_CONTROL_ENABLE": 1,
    "STEP3_TOPOLOGY_GAP_CONTROL_PAIR_IDS": "55353246:37687913,760239:6963539359479390368,791871:37687913,5389884430552920:2703260460721685999",
    "STEP3_TOPOLOGY_GAP_MIN_SUPPORT_COVERAGE_RATIO": 0.35,
    "STEP3_TOPOLOGY_GAP_SMALL_TERMINAL_GAP_MIN_SUPPORT_COVERAGE_RATIO": 0.72,
}
