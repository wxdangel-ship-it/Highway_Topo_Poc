...
def build_production_working_segment(
    *,
    ...
    src_xsec_id = int(row.get("canonical_src_xsec_id", row.get("src", 0)) or row.get("src", 0) or 0)
    dst_xsec_id = int(row.get("canonical_dst_xsec_id", row.get("dst", 0)) or row.get("dst", 0) or 0)
    src_xsec = xsec_map.get(int(src_xsec_id))
    dst_xsec = xsec_map.get(int(dst_xsec_id))
