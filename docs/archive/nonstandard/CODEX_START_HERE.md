...
3) docs/archive/nonstandard/AGENT_PLAYBOOK.md
4) docs/archive/nonstandard/CODEX_GUARDRAILS.md
5) docs/ARTIFACT_PROTOCOL.md
6) docs/archive/nonstandard/WORKSPACE_SETUP.md

## 1. 规则优先级（冲突时按此执行）
SPEC.md > docs/ARTIFACT_PROTOCOL.md > docs/archive/nonstandard/CODEX_GUARDRAILS.md > 其他文档
...
## 4. 目录与代码归属（必读）
- 开工前先读：`SPEC.md`、`docs/archive/nonstandard/AGENT_PLAYBOOK.md`、`docs/archive/nonstandard/CODEX_GUARDRAILS.md`。
