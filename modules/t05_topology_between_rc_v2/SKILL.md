...
6. `history/REAL_RUN_ACCEPTANCE.md`
...
3. 先更新 `architecture/*` 或 `INTERFACE_CONTRACT.md`，再决定是否需要同步 `AGENTS.md`、`SKILL.md`、`history/REAL_RUN_ACCEPTANCE.md`、`review-summary.md`。
...
- 输出应落在 T05-V2 模块文档面：`architecture/*`、`INTERFACE_CONTRACT.md`、`AGENTS.md`、`SKILL.md`、`review-summary.md`，以及必要时更新 `history/REAL_RUN_ACCEPTANCE.md`。
